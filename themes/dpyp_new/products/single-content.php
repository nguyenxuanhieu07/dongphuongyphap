...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h2 class="title-product"><?php echo $product_name; ?></h2>
				...
				<div class="table-advide">
					<table>
						<tr>
							...
							<td>
								<h3 class="title-advice not-should-advide">Đối tượng <span class="title-child">Không nên
										sử dụng</span>
								</h3>
							</td>
						</tr>
			...
			<div id="comments" class="comments-area clearfix  ">
				...
				<form action="" class="comment-form" id="commentform">
					<div class="row row-field">
						<div class="col-md-12">
							<textarea class="form-control" id="comment" name="comment" placeholder="Nội dung bình luận"
						...
						<div class="col-md-6">
							<input class="form-control" id="email" placeholder="Email của bạn" name="email" type="text"
								value="" size="30">
						</div>
					</div>
				...
				<div class="entry-same">
					<div class="post-product">
						...
						<div class="product-info">
							<h3 class="product-title"><a href="#">Đông Trùng Hạ Thảo Sợi Khô Vietfarm Cao Cấp</a></h3>
