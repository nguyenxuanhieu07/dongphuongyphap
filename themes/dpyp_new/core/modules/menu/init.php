...
class Mdn_Menu_walker extends Walker_Nav_Menu 
{ 
  ...
  function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
    ...
    if ($hasMegaMenu) {
      $output .= "<div id=\"mega-menu-{$item->ID}\" class=\"mega-menu-wrap dropdown-menu depth_".$depth."\"><div class='container'><div class='row'>";
      ob_start();
