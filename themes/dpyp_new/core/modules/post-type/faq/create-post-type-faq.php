...
function create_post_type_faq() {
	...
	$labels = array(
		'name'                  => _x( 'Faqs', 'Post Type General Name', 'dongphuong' ),
		'singular_name'         => _x( 'faq', 'Post Type Singular Name', 'dongphuong' ),
		'menu_name'             => __( 'Hỏi đáp', 'dongphuong' ),
		'name_admin_bar'        => __( 'Hỏi đáp', 'dongphuong' ),
	...
	$args = array(
		'label'                 => __( 'faq', 'dongphuong' ),
		'description'           => __( 'Post Type FAQ', 'dongphuong' ),
		'labels'                => $labels,
...
add_action( 'init', 'create_post_type_faq', 0 );