...
function dongphuong_products_metabox($meta_boxes)
{
	$meta_boxes[] = array(
		...
		'fields'      => array(
			...
			array(
				'name' => 'Tiêu đề',
				'id'   => 'usesing-product-title',
				'type' => 'text',
				'size' => 50,
				'tab'  => 'usesing-product',
			),
			array(
				'name'    => 'Nội dung cách dùng',
			...
			array(
				'name'        => __('Lý do'),
				'id'          => 'product-reason-group',
				'type'        => 'group',
				'clone'       => true,
				'sort_clone'  => true,
				'collapsible' => true,
				'group_title' => array('field' => 'product-reason-content'),
				'add_button'  => 'Thêm',
				'tab'         => 'product-reason',
				'fields'      => array(
					array(
						'name' => '',
						'id'   => 'product-reason-content',
						'type' => 'text',
						'size' => 50,
					),
				),
