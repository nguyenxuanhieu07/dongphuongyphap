...
if (!function_exists('wb_create_post_type_disease')) {
	function wb_create_post_type_disease()
	{
		if (current_user_can('user_aprove_comments'))
			return;
		$labels  = array(
			'name'                  => _x('Bệnh điều trị', 'Post Type Name', 'dongphuong_yphap'),
			'singular_name'         => _x('Bệnh điều trị', 'Post Type Singular Name', 'dongphuong_yphap'),
			'menu_name'             => __('Bệnh điều trị', 'dongphuong_yphap'),
			'name_admin_bar'        => __('Bệnh điều trị', 'dongphuong_yphap'),
			'archives'              => __('Tất cả Bệnh điều trị', 'dongphuong_yphap'),
			'parent_item_colon'     => __('Parent Item:', 'dongphuong_yphap'),
			'all_items'             => __('Tất cả Bệnh điều trị', 'dongphuong_yphap'),
			'add_new_item'          => __('Thêm Bệnh điều trị', 'dongphuong_yphap'),
		...
		$args    = array(
			'label'               => __('Bệnh điều trị', 'dongphuong_yphap'),
			'description'         => __('Tổng hợp những Bệnh điều trị', 'dongphuong_yphap'),
			'labels'              => $labels,
